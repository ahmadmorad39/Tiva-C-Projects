...
#define GPIO_PORTB_BASE     0x40059000  // GPIO Port B (high speed)
...
#define GPIOA_AHB           ((GPIO_Type *)GPIO_PORTA_AHB_BASE)
#define GPIOB_AHB           ((GPIO_Type *)GPIO_PORTB_AHB_BASE)
#define GPIOC_AHB           ((GPIO_Type *)GPIO_PORTC_AHB_BASE)
#define GPIOD_AHB           ((GPIO_Type *)GPIO_PORTD_AHB_BASE)
#define GPIOE_AHB           ((GPIO_Type *)GPIO_PORTE_AHB_BASE)
#define GPIOF_AHB           ((GPIO_Type *)GPIO_PORTF_AHB_BASE)
#define GPIOG_AHB           ((GPIO_Type *)GPIO_PORTG_AHB_BASE)
